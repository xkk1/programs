loading = (function() {
  ...
  function loadScene(fun1) {
    ...
    gl.shaderSource(vertexShader, vertexShaderScriptText);
    ...
    gl.shaderSource(fragmentShader, fragmentShaderScriptText);
